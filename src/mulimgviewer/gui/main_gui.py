...
class MulimgViewerGui ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"MulimgViewer", pos = wx.DefaultPosition, size = wx.Size( 1066,1554 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		choice_input_modeChoices = [ u"Sequential", u"Parallel auto", u"Parallel manual", u"Image File List", u"Video File" ]
		...
		self.m_button10 = wx.Button( self.m_panel1, wx.ID_ANY, u"▶", wx.DefaultPosition, wx.Size( 50,30 ), 0 )
		self.m_button10.SetFont( wx.Font( 9, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "宋体" ) )
		...
		fgSizer4.Add( self.m_staticText1, 1, wx.ALL|wx.EXPAND, 5 )
		...
		self.m_staticline13.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.m_staticText382 = wx.StaticText( self.m_panel4, wx.ID_ANY, u"Videomode", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText382.Wrap( -1 )

		self.m_staticText382.SetFont( wx.Font( 12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "宋体" ) )

		bSizer19.Add( self.m_staticText382, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )

		self.m_staticline101 = wx.StaticLine( self.m_panel4, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_VERTICAL )
		bSizer19.Add( self.m_staticline101, 0, wx.EXPAND |wx.ALL, 5 )

		self.Enable_Video_Mode = wx.CheckBox( self.m_panel4, wx.ID_ANY, u"Enable Video Mode", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer19.Add( self.Enable_Video_Mode, 0, wx.ALL, 5 )

		self.m_checkBox31 = wx.CheckBox( self.m_panel4, wx.ID_ANY, u"Enable Cache", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer19.Add( self.m_checkBox31, 0, wx.ALL, 5 )
		...
		self.Frame_Interval_s = wx.StaticText( self.m_panel4, wx.ID_ANY, u"Frame Interval (s)                                  ", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.Frame_Interval_s.Wrap( -1 )

		bSizer20.Add( self.Frame_Interval_s, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )

		self.frame_interval_ctrl = wx.TextCtrl( self.m_panel4, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( -1,-1 ), 0 )
		bSizer20.Add( self.frame_interval_ctrl, 0, wx.ALL, 5 )
		...
		self.Parallel_Threads = wx.StaticText( self.m_panel4, wx.ID_ANY, u"Parallel Threads                                    ", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.Parallel_Threads.Wrap( -1 )

		bSizer211.Add( self.Parallel_Threads, 0, wx.ALL, 5 )

		self.m_textCtrl16 = wx.TextCtrl( self.m_panel4, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer211.Add( self.m_textCtrl16, 0, wx.ALL, 5 )


		fgSizer3.Add( bSizer211, 1, wx.EXPAND, 5 )

		bSizer221 = wx.BoxSizer( wx.HORIZONTAL )

		self.Cached_Frames_                                   = wx.StaticText( self.m_panel4, wx.ID_ANY, u"Cached Frames ±                                  ", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.Cached_Frames_                                  .Wrap( -1 )

		bSizer221.Add( self.Cached_Frames_                                  , 0, wx.ALL, 5 )

		self.m_textCtrl17 = wx.TextCtrl( self.m_panel4, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer221.Add( self.m_textCtrl17, 0, wx.ALL, 5 )


		fgSizer3.Add( bSizer221, 1, wx.EXPAND, 5 )

		self.m_staticline12 = wx.StaticLine( self.m_panel4, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL )
		...
		wSizer2.Add( self.m_staticText33, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		bSizer13.Add( self.m_panel4, 1, wx.ALL, 5 )
